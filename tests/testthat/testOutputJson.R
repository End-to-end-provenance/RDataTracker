...
test_that("procedure nodes",
	{
		# null case
		ddg.proc.nodes <- read.csv("./testOutputJson/cases/proc_null.csv", stringsAsFactors=FALSE)
		expect_equal( as.character(.ddg.json.proc(NULL, NULL)), NA )
		
		# general case: 1 node
		ddg.proc.nodes <- read.csv("./testOutputJson/cases/proc_1.csv", stringsAsFactors=FALSE)
		...
		ddg.proc.nodes <- read.csv("./testOutputJson/cases/proc_3.csv", stringsAsFactors=FALSE)
		expect_equal( as.character( .ddg.json.proc(
						LABEL.NAMES$activity.proc, 
						LABEL.PREFIX) ), 
...
test_that("data nodes", 
	{
		# null case
		ddg.data.nodes <- read.csv("./testOutputJson/cases/data_null.csv", stringsAsFactors=FALSE)
		expect_equal( as.character(.ddg.json.data(NULL, NULL)), NA )
		
		# general case: 1 node
		ddg.data.nodes <- read.csv("./testOutputJson/cases/data_1.csv", stringsAsFactors=FALSE)
		...
		# general case: 3 nodes
		ddg.data.nodes <- read.csv("./testOutputJson/cases/data_3.csv", stringsAsFactors=FALSE)
		expect_equal( as.character( .ddg.json.data(
						LABEL.NAMES$entity.data, 
						LABEL.PREFIX) ), 

Understanding RDataTracker’s Prov-Json Output        json ver. 2.1
==================================================================
...
![alt text](images/ddg.png "Example provenance graph")
...
* Script (turquoise): A node represented by an executed script other than the script explicitly run using RDataTracker.

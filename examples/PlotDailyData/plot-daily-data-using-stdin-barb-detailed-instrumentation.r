...
ddg.r.script <- paste(getwd(),"/plot-daily-data-using-stdin-barb-detailed-instrumentation.r",sep="")
...
ddg.data.out("as.character", "file.name")

ts.data <- read.data(file.name)
ddg.wsnapshot.out("read.data", "ts.data")

variable <- get.variable()
ddg.data.out("as.character", "variable")

...
calibrate <- function(xx) {
  ...
  ddg.snapshot.out("calibrate","calibrated-data.csv",xx)
...
quality.control <- function(xx) {
  ...
  ddg.snapshot.out("quality.control","quality-controlled-data.csv",xx)
...
gap.fill <- function(xx) {
  ...
  ddg.snapshot.out("gap.fill","gap-filled-data.csv",xx)
...
plot.data <- function(xx,v) {
  ...
  ddg.file.copy.out("plot.data",jname)
}

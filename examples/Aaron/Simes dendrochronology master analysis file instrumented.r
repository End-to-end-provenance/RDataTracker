...
ddg.procedure("Read raw data files", ins=list("trees03.csv", "hf086-01-dendro.csv"), outs=list("trees", "dendro"))
...
ddg.start("Create contour plots of trees")
...
plot.7 <- trees[plot == 7, ]
plot.8 <- trees[plot == 8, ]
ddg.procedure("extract tree location", ins=list("trees"), outs=list("plot.1","plot.2","plot.3","plot.4","plot.5","plot.6","plot.7","plot.8"))
...
# remove NAs
ddg.start("Remove NAs")
p1 <- na.omit(plot.1)
ddg.procedure("remove NAs from plot 1", ins=list("plot.1"), outs=list("p1"))
p2 <- na.omit(plot.2)
ddg.procedure("remove NAs from plot 2", ins=list("plot.2"), outs=list("p2"))
p3 <- na.omit(plot.3)
ddg.procedure("remove NAs from plot 3", ins=list("plot.3"), outs=list("p3"))
p4 <- na.omit(plot.4)
ddg.procedure("remove NAs from plot 4", ins=list("plot.4"), outs=list("p4"))
p5 <- na.omit(plot.5)
ddg.procedure("remove NAs from plot 5", ins=list("plot.5"), outs=list("p5"))
p6 <- na.omit(plot.6)
ddg.procedure("remove NAs from plot 6", ins=list("plot.6"), outs=list("p6"))
p7 <- na.omit(plot.7)
ddg.procedure("remove NAs from plot 7", ins=list("plot.7"), outs=list("p7"))
p8 <- na.omit(plot.8)
ddg.procedure("remove NAs from plot 8", ins=list("plot.8"), outs=list("p8"))
ddg.finish("Remove NAs")

# set up contour plot grids]
ddg.start("Set up contour plot grids")
...
ddg.procedure("contour plot grids - plot 1", ins=list("p1"), outs=list("p.1.i"))
p.2.i <- interp(p2$xcoord, p2$ycoord, scale(p2$zelev), xo = seq(0, 90, length = 40), 
    yo = seq(0, 90, length = 40), duplicate = "strip", extrap = FALSE, linear = FALSE)
ddg.procedure("contour plot grids - plot 2", ins=list("p2"), outs=list("p.2.i"))
p.3.i <- interp(p3$xcoord, p3$ycoord, scale(p3$zelev), xo = seq(0, 90, length = 40), 
    yo = seq(0, 90, length = 40), duplicate = "strip", extrap = FALSE, linear = FALSE)
ddg.procedure("contour plot grids - plot 3", ins=list("p3"), outs=list("p.3.i"))
p.4.i <- interp(p4$xcoord, p4$ycoord, scale(p4$zelev), xo = seq(0, 90, length = 40), 
    yo = seq(0, 90, length = 40), duplicate = "strip", extrap = FALSE, linear = FALSE)
ddg.procedure("contour plot grids - plot 4", ins=list("p4"), outs=list("p.4.i"))
p.5.i <- interp(p5$xcoord, p5$ycoord, scale(p5$zelev), xo = seq(0, 90, length = 40), 
    yo = seq(0, 90, length = 40), duplicate = "strip", extrap = FALSE, linear = FALSE)
ddg.procedure("contour plot grids - plot 5", ins=list("p5"), outs=list("p.5.i"))
p.6.i <- interp(p6$xcoord, p6$ycoord, scale(p6$zelev), xo = seq(0, 90, length = 40), 
    yo = seq(0, 90, length = 40), duplicate = "strip", extrap = FALSE, linear = FALSE)
ddg.procedure("contour plot grids - plot 6", ins=list("p6"), outs=list("p.6.i"))
p.7.i <- interp(p7$xcoord, p7$ycoord, scale(p7$zelev), xo = seq(0, 90, length = 40), 
    yo = seq(0, 90, length = 40), duplicate = "strip", extrap = FALSE, linear = FALSE)
ddg.procedure("contour plot grids - plot 7", ins=list("p7"), outs=list("p.7.i"))
p.8.i <- interp(p8$xcoord, p8$ycoord, scale(p8$zelev), xo = seq(0, 90, length = 40), 
    yo = seq(0, 90, length = 40), duplicate = "strip", extrap = FALSE, linear = FALSE)
ddg.procedure("contour plot grids - plot 8", ins=list("p8"), outs=list("p.8.i"))
ddg.finish("Set up contour plot grids")
...
ddg.procedure("Hemlock plot", ins=list("plot.1","plot.2","plot.3","plot.4","plot.5","plot.6",
	"p.1.i","p.2.i","p.3.i","p.4.i","p.5.i","p.6.i"), outs=list("hemlock_countors.pdf"))


# begin hardwoods
#ddg.start("Hardwood plot")
...
dev.off()
#```
#ddg.finish("Hardwood plot")
ddg.procedure("Hardwood plot", ins=list("plot.7","plot.8",
	"p.7.i","p.8.i"), outs=list("hardwood_countors.pdf"))

ddg.finish("Create contour plots of trees")
...
ddg.procedure("Create spatial point patterns", ins=list("plot.1","plot.2","plot.3","plot.4","plot.5","plot.6","plot.7","plot.8"))
...
#```
ddg.data.out("plot.1", pname="Create spatial point patterns")
ddg.data.out("plot.2", pname="Create spatial point patterns")
ddg.data.out("plot.3", pname="Create spatial point patterns")
ddg.data.out("plot.4", pname="Create spatial point patterns")
ddg.data.out("plot.5", pname="Create spatial point patterns")
ddg.data.out("plot.6", pname="Create spatial point patterns")
ddg.data.out("plot.7", pname="Create spatial point patterns")
ddg.data.out("plot.8", pname="Create spatial point patterns")
...
ddg.procedure("Plot, generate contours, and Kobs vs Ktheor", ins=list("plot.1","plot.2","plot.3","plot.4","plot.5","plot.6","plot.7","plot.8"))
...
ddg.procedure("Run maximum absolute deviation tests of CSR on ppp data", ins=list("plot.1","plot.2","plot.3","plot.4","plot.5","plot.6","plot.7","plot.8"))
...
head(tree.ages)
ddg.procedure("Extract tree ages", ins=list("trees", "dendro"), outs=list("tree.ages"))
#```
...
#Create the plot
#procedure("Create the plot")
ddg.procedure("Create plot", ins=list("tree.ages"))
...
dev.off()
ddg.data.out("tree.ages", pname="Create plot")
ddg.file.out("Figure 7 - age_dbh.pdf", pname="Create plot")
ddg.finish("Plot age x dbh")
...
ddg.start("Read environmental data")
#Climate data: 
...
ddg.start("Harvard Forest climate data")
ddg.procedure("Read Shaler data")
#```r
...
#```r
ddg.procedure("Read Fisher data")
...
ddg.procedure("Combine Fisher and Shaler data")
#```r
...
#```
ddg.finish("Harvard Forest climate data")

#Amherst climate data
ddg.procedure("Amherst climate data")
...
ddg.procedure("Leverett climate data")
#```r
...
#```
ddg.finish("Read environmental data")
...
ddg.procedure("Rework into time-series")
...
ddg.procedure("Reduce to 5 species")
...
ddg.procedure("Individual traces of rBAI as a function of year")
...
ddg.procedure("10-panel plot per Rhodora specs")
...
ddg.procedure("Compare 1-d and 2-d GAMs")

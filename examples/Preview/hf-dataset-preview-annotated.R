...
ddg.r.script.path = paste(testDir,"hf-dataset-preview-annotated.R",sep="/")
...
get.time.series.ids <- function(dataset.id) {
  ...
  return(ddg.return.value(time.series.ids))
}
...
# create string for datafile.id
  ...
  return(ddg.return.value(datafile.id))
}
...
get.all.datafile.ids <- function(ns) {
  ...
  return(ddg.return.value(datafile.ids))
}
...
get.data.url <- function(eml, datafile.id) {
  ...
  return(ddg.return.value(data.url))
}
...
get.variable.type <- function(ns) {
  ...
  return(ddg.return.value(var.type))
}
...
get.all.variable.types <- function(ns) {
  ...
  return(ddg.return.value(var.types))
}
...
get.variable.format.string <- function(ns) {
  ...
  return(ddg.return.value(var.format.string))
}
...
get.all.variable.format.strings <- function(ns) {
  ...
  return(ddg.return.value(var.format.strings))
}
...
get.summary.stats.data.frame <- function(xx) {  
  ...
  return(ddg.return.value(xx.sum))
}
...
get.plot.dataframe <- function(xx, max.rows) {
  ...
  return(ddg.return.value(xx.plt))
}
...
get.plot.type <- function(datafile.id) {
  ...
  return(ddg.return.value(plot.type))
}

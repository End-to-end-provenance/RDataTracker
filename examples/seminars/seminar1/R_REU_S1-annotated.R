...
# Begin annotations for Session 1 Seminar.
setwd("D:/Users/Luis/Dropbox/HarvardForest/RDataTracker Annotations/seminar one")
r.script.path <- paste(getwd(),"/R_REU_S1-annotated.r",sep="")
...
ddg.procedure("Create Data Frame", ins=list("treeID","species", "plotID", "dbh"),
              outs.data=list("data"))
...
ddg.file("reu_r_data1.csv",dname="data2")
#print the data
...
all
summary(all)
ddg.procedure("Row Binding", ins=list("data", "data2"), outs.data=list("all"))
ddg.finish("Load Data")
#SINGLE VARIABLE
...
ddg.procedure("Create histograms", ins=list("all"), outs.graphic="Histogram of DBH")
...
ddg.procedure("Create Boxplot", ins=list("all"), outs.graphic="BoxPlot of DBH")
...
ddg.procedure("Create Plot", ins=list("all"), outs.graphic="Plot of DBH")
ddg.finish("Plot Data")
#SAVING DATA
ddg.start("Save Data")
write.table(all,"reu.r.data2.csv")
ddg.procedure("Write Data", ins=list("all"), outs.file=list("reu.r.data2.csv"))
ddg.finish("Save Data")
ddg.finish("Script")
# Save DDG
ddg.save()

...
## Directories
testDir <- "C:/github/rdatatracker/scriptTests/FunctionNonlocalsTest/"
setwd(testDir)
...
# Run the script
#ddg.run("FunctionNonlocalsTest.R", "C:/github/rdatatracker/scriptTests/FunctionNonlocalsTest", ignore.ddg.calls = F)
prov.run("FunctionNonlocalsTest.R", "C:/github/rdatatracker/scriptTests/FunctionNonlocalsTest", annotate.inside.functions=TRUE, max.loops=1, 
	snapshot.size=10)

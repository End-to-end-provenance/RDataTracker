...
# The variables below are smaller so that the DDG has a manageable size when recorded to full detail.
...
#area3str <- ""
area1str <- "1(0.9) , 2(0.1)"
area2str <- "1(0.3), 2(0.7)"
area3str <- ""
